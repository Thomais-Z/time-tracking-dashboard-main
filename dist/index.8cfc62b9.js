...
const daily = function() {
    currentTime.forEach((_, i)=>{
        currentTime[i].innerHTML = `${_dataJson[i].timeframes.daily.current}hrs`;
        previousTime[i].innerHTML = `Yesterday - ${_dataJson[i].timeframes.daily.previous}hrs`;
    });
};
daily();
const weekly = function() {
    currentTime.forEach((_, i)=>{
        currentTime[i].innerHTML = `${_dataJson[i].timeframes.weekly.current}hrs`;
        previousTime[i].innerHTML = `Yesterday - ${_dataJson[i].timeframes.weekly.previous}hrs`;
    });
};
const monthly = function() {
    currentTime.forEach((_, i)=>{
        currentTime[i].innerHTML = `${_dataJson[i].timeframes.monthly.current}hrs`;
        previousTime[i].innerHTML = `Yesterday - ${_dataJson[i].timeframes.monthly.previous}hrs`;
    });
};
...
},{}]},["hIFAM","6rimH"], "6rimH", "parcelRequiref3e3")
